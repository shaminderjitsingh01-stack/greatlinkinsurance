        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a
                  href="mailto:info@greatlinkinsurance.sg"
                  className="flex items-center gap-3 text-gray-400 hover:text-teal-400 transition-colors duration-200"
                >
                  <Mail className="w-5 h-5 text-teal-400 flex-shrink-0" />
                  info@greatlinkinsurance.sg
                </a>
              </li>
              <li>
                <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            <div className="text-gray-500 text-xs text-center lg:text-right max-w-2xl">
              <p>
                GreatLink Insurance Pte Ltd is a registered insurance broker regulated by
                the Monetary Authority of Singapore (MAS). Registration No. 201500000A.
                Insurance products are underwritten by our partner insurers. Terms and
                conditions apply.
              </p>
            </div>
          </div>
